...
const fetchPlaningData = () => {
    ...
    axios.get(`${DjangoConfig.apiUrl}/rtqm/rtqm_api/?${queryParams}`, {
        ...
        .then(response => {
            ...
            setPassCount(responseData.pass_count);
            setRejectCount(responseData.reject_count);
            setRectifiedCount(responseData.rectified_count);
            setDefectCount(responseData.defect_count);
        })
        .catch(error => {
