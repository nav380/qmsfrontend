...
const PassSizeInput = () => {
    ...
    const getQuantityForSize = (size) => {
        const items = orderItems.filter(item => item.size === size);
        let totalQuantity = 0;
        items.forEach(item => {
            ...
            <div className="flex justify-normal w-full h-72 black-border-1">
                <div className="w-full">
                    ...
                    <div className='flex flex-wrap mt-1 bg-slate-100 justify-between'>
                        ...
                        <div>
                            {/* <button className='btn  btn-primary w-24 float-end' onClick={resetPassStorage1}> Undo </button> */}
                        </div>
                    </div>
...
// const item = state.items1.find(item => item.size === size);
// if (item) {
//     item.pop();
// }