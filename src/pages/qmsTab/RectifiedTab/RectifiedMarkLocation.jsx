...
import { addBackCoordinates, addFrontCoordinates, resetOperations } from '../../../utils/slices/DefectMasterSlice';
import { toast } from 'react-toastify';
import DjangoConfig from '../../../config/Config';
import axios from 'axios';

const RectifiedMarkLocation = () => {
    ...
    const [RtqmConterId,setRtqmConterId] = useState("")
    ...
    const localData = ()=>{
        const stored_counter_data_str = localStorage.getItem("counter_data");
        const stored_counter_data = JSON.parse(stored_counter_data_str);
        const stored_status = stored_counter_data.status;
        const stored_id = stored_counter_data.id;
        setRtqmConterId(stored_id)
        const stored_sewingPlanData = stored_counter_data.sewingPlanData;
        console.log("counterData",stored_counter_data)
...
export default RectifiedMarkLocation;