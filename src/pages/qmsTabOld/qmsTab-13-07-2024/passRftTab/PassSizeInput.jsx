...
const PassSizeInput = () => {
    ...
    // console.log("sewingPlanData nrrrrrrrrrrrrr",sewingPlanData)
    ...
    const renderSizeButtons = () => {
        return sizeData.map((size, index) => (
            <div key={index} className="relative w-full bg-blue-500 p-4 h-20 mt-1 rounded-lg shadow-md">
                ...
                {/* <p className="absolute text-white z-10">{size.quantity}</p> */}
                ...
                {/* <p className="absolute ml-60 text-white z-10">{getQuantityForSize(size.size)}</p> */}
