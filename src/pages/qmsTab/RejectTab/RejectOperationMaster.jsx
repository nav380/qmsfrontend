...
const RejectOperationMaster = () => {
    const defectSize = useSelector(state => state.rejectMaster.size);
    const operationsData = useSelector(state => state.rejectMaster.operations) || [];
    ...
    const handleSave = (id, name) => {
        if (id && name) {
            ...
            navigate("/qms-tab/reject-defect-master");
        } else {
...
export default RejectOperationMaster;
