...
const ReCuttingInput = () => {
    ...
    const handleQuantityChange = (event) => {
        ...
        // console.log('sizeqnty.cutpcs=',sizeQuantityData)
        ...
        if (prevqnty === undefined) {
            ...
            console.log('prevqnty.total_input_qty', prevqnty.total_input_qty)
            sewdtpreqty = prevqnty.total_input_qty
            settilladdqty(sewdtpreqty)
        }
        setSizepreqty(sewdtpreqty + value)
        // console.log('sewdtpreqty=========ppppppppppppp', sewdtpreqty)
    ...
    const saveSizeInput = (quantityToSave) => {
        ...
        if (selectedSize && quantityToSave > 0) {
            ...
            axios.post(`${DjangoConfig.apiUrl}/rtqm/recutting_master/`, mtData
            ).then(response => {
    ...
    const handelChangePLan = () => {
        // handleClearStore()
        navigate('/cutting-input/recuttingmaster');
    }
        ...
        <>
            ...
            <div className="flex flex-col w-full h-full border rounded-md p-4 m-2">
                <div className="w-full mt-0 mb-5 flex  justify-between">
                    <div className='text-2xl font-bold pl-5'> Pocess Name:&nbsp;&nbsp; {userlogData.process_name}&nbsp;&nbsp;&nbsp;  Section Name :&nbsp;&nbsp; {userlogData.section_name}</div>
                    {/* <div className='text-2xl font-bold pl-5'>ReCutting Input</div> */}
