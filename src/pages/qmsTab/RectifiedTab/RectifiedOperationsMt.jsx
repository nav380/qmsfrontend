...
import { addOperation, resetOperations } from "../../../utils/slices/DefectMasterSlice";
import axios from 'axios';
import { useNavigate } from "react-router-dom";
import DjangoConfig from '../../../config/Config';

const RectifiedOperationsMaster = () => {
    ...
    const handleSave = (id, name) => {
        console.log(id, name)
        if (id && name) {
            const obData = { id, name };
            const obDataJSON = JSON.stringify(obData);
            localStorage.setItem('obData', obDataJSON);
            navigate("/qms-tab/rectified-defect-select");
        } else {
...
export default RectifiedOperationsMaster;
